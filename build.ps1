...
(Get-Content .\template\AppxManifest.xml).Replace("@@NAME@@",$name).Replace("@@UUID@@",$uuid).Replace("@@TITLE@@",$title).Replace("@@NAME2@@",$name2).Replace("@@UUID2@@",$uuid2).Replace("@@TITLE2@@",$title2).Replace("@@APPNAME@@",$app_name).Replace("@@APPID@@",$app_id).Replace("@@APPDESCRIPTION@@",$app_description) | Out-File -Encoding utf8 .\Release\sparse-pkg\AppxManifest.xml -Force
